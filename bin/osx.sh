...
# Create dir in case sublime text is not yet installed
mkdir -p "${HOME}/Library/Application Support/Sublime Text 3/Packages/User/"
# remove existing config
rm "${HOME}/Library/Application Support/Sublime Text 3/Packages/User/Preferences.sublime-settings"
# create symlink
ln -s "${DOTFILESDIR}/sublime" "${HOME}/Library/Application Support/Sublime Text 3/Packages/User/Preferences.sublime-settings"
